  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen">
      ...
      <section className="relative bg-slate-950 text-white overflow-hidden border-b border-slate-800">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/60 via-slate-950/30 to-transparent w-full lg:w-2/3"></div>

        {/* Patrón de puntos para darle un toque técnico/industrial */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Izquierda: Mensaje Original con drop-shadow para extra contraste */}
          <div className="lg:col-span-7 space-y-8 drop-shadow-2xl">
            ...
            <p className="text-white text-base sm:text-lg max-w-2xl font-medium leading-relaxed bg-slate-950/60 p-6 rounded-xl backdrop-blur-md border border-white/10 shadow-2xl">
              La evidente crisis climática que afecta al planeta nos obliga a reutilizar los materiales para aprovechar su máxima vida útil posible. <strong className='text-red-600 font-inter'>M</strong><strong className="text-white font-black">ETALYSA ACEROS</strong> ayuda en la protección del medio ambiente proporcionando un nuevo uso al fierro de construcción siendo pioneros en el reciclaje de la barra de acero, entregando materia prima a las principales siderúrgicas del país para la refundación u obtención de cloruro férrico, elemento clave en la desalinización de las aguas marinas.
            </p>

            <div className="pt-2 flex flex-col sm:flex-row gap-4">
              <Link
                href="/contacto"
                className="inline-flex justify-center items-center px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold text-sm tracking-wider uppercase transition-all shadow-lg shadow-red-900/30 rounded-md"
              >
                Contacto directo
              </Link>
              <Link
                href="/servicios"
                className="inline-flex justify-center items-center px-8 py-4 bg-slate-950/60 hover:bg-slate-900 text-white backdrop-blur-sm border border-slate-700 font-bold text-sm tracking-wider uppercase transition-all rounded-md"
              >
          ...
          <div className="lg:col-span-5 bg-red-950/80 backdrop-blur-md border-2 border-red-900/50 p-8 space-y-6 rounded-xl shadow-2xl relative">
            ...
            <div className="border-b border-red-900/50 pb-4">
              <span className="text-xs font-mono text-red-200/70 uppercase tracking-widest block">Capacidad y Garantía Operativa</span>
              <h2 className="text-2xl font-black text-white uppercase mt-1">Cobertura Nacional</h2>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div className="bg-black/40 p-4 border border-red-900/30 rounded-lg shadow-inner">
                <span className="text-red-400 font-mono font-black text-2xl block mb-1">+250<span className="text-xs"> TON</span></span>
                <span className="text-white/90 font-bold block">Procesamiento Mensual</span>
                <span className="text-red-200/50 text-xs">De chatarra y barra de acero</span>
              </div>
              <div className="bg-black/40 p-4 border border-red-900/30 rounded-lg shadow-inner">
                <span className="text-red-400 font-mono font-black text-2xl block mb-1">6.000<span className="text-xs"> m²</span></span>
                <span className="text-white/90 font-bold block">Instalaciones</span>
                <span className="text-red-200/50 text-xs">Galpones y pesaje de 60 ton</span>
              </div>
            </div>

            {/* Badges de Confianza */}
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3 bg-black/40 p-3 rounded border border-red-900/30 shadow-inner">
                ...
                <div>
                  <span className="block text-white/90 text-xs font-bold uppercase">Trazabilidad Ambiental</span>
                  <span className="block text-red-200/50 text-[10px] uppercase">Ley REP 20.920 • SINADER</span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-black/40 p-3 rounded border border-red-900/30 shadow-inner">
                <div className="w-8 h-8 rounded-full bg-red-900/50 flex items-center justify-center text-red-400">
                ...
                <div>
                  <span className="block text-white/90 text-xs font-bold uppercase">Inclusión Laboral</span>
                  <span className="block text-red-200/50 text-[10px] uppercase">Entorno diverso y seguro</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Banner de Clientes (Marquee con Imágenes) - Movido debajo del Hero */}
      <section className="bg-slate-100 py-12 border-b border-slate-200 overflow-hidden relative">
        <style>{`
          @keyframes marquee {
        ...
        <div className="relative w-full overflow-hidden">
          <div className="animate-marquee flex items-center">
            ...
            {[
              ...
              <div
                key={index}
                className="flex shrink-0 items-center justify-center px-4 sm:px-6 mx-1 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300"
              >
                <img
                  src={cliente.logo}
                  alt={cliente.nombre}
